...
# 次のコードは、全てのユーザーに対して、ユーザーが入店したかどうかを管理する
# "enterd_flag"というカラムをfalseにするrakeタスクです。
# rakeタスクの使い方を確認した上で、下記のrakeタスクを
# ターミナルから実行するためには、どのようなコマンドを実行すればいいか、答えてください。
...
# wheneverというgemを組み合わせて利用します。興味のある方は、是非下記リンクを参考にしてみてください。
