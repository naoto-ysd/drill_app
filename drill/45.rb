...
# このとき、以下の設問にお答えください。
# ①showアクションの中にあるarticleという変数定義ですが、
# このままだとビューの表示を意図した通りに行うことができません。その理由と解決策を解説してください。
...
そのため、例えば「localhost:3000/tweets/3」というURLが指定されると、
paramsの「:id」というキーのバリューとして「3」が代入される。
